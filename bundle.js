...
async function renderHomePage() {
    try {
        ...
        /* eslint-disable */console.log(...oo_oo(`ccd8ce12_0`,error))
...
async function renderQueriedCity(city=document.querySelector('input').value) {
    try {
        ...
        /* eslint-disable */console.log(...oo_oo(`ccd8ce12_1`,newObjForecast))
        ...
        /* eslint-disable */console.log(...oo_oo(`ccd8ce12_2`,error))
...
async function queryClimate(location) {
    try {
        ...
        /* eslint-disable */console.log(...oo_oo(`b2043320_0`,retrievedData))
...
async function queryForecast(location){
    try {
        ...
        let retrievedData = await response.json()
        /* eslint-disable */console.log(...oo_oo(`b2043320_1`,retrievedData))
        return retrievedData;
    } catch (error) {
        throw error
    }
