...
async function queryClimate(location) {
    try {
        ...
        /* eslint-disable */console.log(...oo_oo(`e66a1647_0`,retrievedData))
...
async function queryForecast(location){
    try {
        ...
        let retrievedData = await response.json()
        /* eslint-disable */console.log(...oo_oo(`e66a1647_1`,retrievedData))
        return retrievedData;
    } catch (error) {
        throw error
    }
